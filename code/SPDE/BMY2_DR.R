...
## Spatial data
br_nb <- poly2nb(as(DR_comb, "Spatial"))
nb2INLA("./data/br_adj", br_nb)
br_adj <- "./data/br_adj"
...
#ggsave("./fig/rr_total.tiff", plot = last_plot(),
...
#ggsave("./fig/rr_year_total.tiff", plot = last_plot(),
 #      dpi = 300, width = 320, height = 300, units = "mm")
...
summary(RR01)
save(RR01, file="./data/RR01.RData")
br_adj <- "./data/br_adj"
RR001 <- inla(numcase ~ 1 +
               f(id_cell,
                 model = "bym2",
                 hyper = prec_bym2,
                 graph = br_adj,
             ...
             control.compute = list(dic = TRUE))
summary(RR001)
save(RR001, file="./data/RR001.RData")
